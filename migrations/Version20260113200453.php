 ...
 */
final class Version20260113200453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto ALTER categoria_id SET NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto ALTER categoria_id DROP NOT NULL');
    }
}
