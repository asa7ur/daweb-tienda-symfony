 ...
 */
final class Version20251028194638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE producto (id SERIAL NOT NULL, categoria_id INT DEFAULT NULL, codigo VARCHAR(6) NOT NULL, precio DOUBLE PRECISION NOT NULL, nombre VARCHAR(255) NOT NULL, nombre_corto VARCHAR(50) DEFAULT NULL, descripcion TEXT NOT NULL, PRIMARY KEY(id))');
